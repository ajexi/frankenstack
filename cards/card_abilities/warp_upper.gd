...
func trigger_ability(card_manager: CardManager, battle_manager: BattleManager, card : CombinedCard, turn_player : String, effect_trigger : String) -> void:
	...
	var first_card_upper_part = selected_cards[0].upper_card_part
	var second_card_upper_part = selected_cards[1].upper_card_part
	selected_cards[0].upper_card_part = second_card_upper_part
	selected_cards[1].upper_card_part = first_card_upper_part
